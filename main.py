...
BTN_GO.place(relx=.36, rely=.8)
BTN_DWNLD1.place (relx=.55, rely=.65)
BTN_DWNLD2.place (relx=.55, rely=.7)
LABEL1.place(relx=.1, rely=.1)
LABEL2.place(relx=.1, rely=.15)
LABEL3.place(relx=.1, rely=.2)
LABEL4.place(relx=.1, rely=.25)
LABEL5.place(relx=.1, rely=.3)
LABEL6.place(relx=.1, rely=.35)
LABEL7.place(relx=.1, rely=.4)
LABEL8.place(relx=.1, rely=.45)
LABEL9.place(relx=.1, rely=.5)
LABEL10.place(relx=.1, rely=.55)
LABEL11.place(relx=.1, rely=.6)
LABEL12.place(relx=.1, rely=.65)
LABEL13.place(relx=.1, rely=.7)

ENTRY1.place(relx=.55, rely=.1)
ENTRY2.place(relx=.55, rely=.15)
ENTRY3.place(relx=.55, rely=.2)
ENTRY4.place(relx=.55, rely=.25)
ENTRY5.place(relx=.55, rely=.3)
ENTRY6.place(relx=.55, rely=.35)
ENTRY7.place(relx=.55, rely=.4)
ENTRY8.place(relx=.55, rely=.45)
ENTRY9.place(relx=.55, rely=.5)
ENTRY10.place(relx=.55, rely=.55)
ENTRY11.place(relx=.55, rely=.6)
...
def ascents():
    ...
    slise_finish = column_list.index('Наименование и техническая характеристика')
        ...
        for i in range(len(pipe_parsed)):
            if pipe_parsed['Тип прокладки'][i] == 'надземная' and pipe_parsed['Тип трубопровода'][i] == 'прямой':
                if pipe_parsed['Диаметр'][i] <= 108:
                    ...
                    pipe_parsed["mati_100_60mm"][i] = mati_m100_60
                    steel = round(pi * (pipe_parsed['Диаметр'][i] / 1000 + (thickness / 1000) * 2), 3)
                    pipe_parsed["steel_0_5mm"][i] = steel
                ...
                print(pipe_parsed['Диаметр'][i], pipe_parsed['Количество'][i])
...
for i in range(len(pipeline_with_insulation)):
    if pipeline_with_insulation['Тип прокладки'][i] == 'надземная':
        ...
        pipeline_with_insulation['Лак БТ-7,кг * Количество'] = np.nan
        pipeline_with_insulation['Лак БТ-7,м2 * Количество'] = np.nan
        pipeline_with_insulation['Лак БТ-7,кг'][i] = pipeline_with_insulation['Лак БТ-7,кг'][i]
...
def mpd_write():
    book = openpyxl.load_workbook("Template-MPD0001.xlsx")
    sheet = book['Sheet1']
    l = len(mpd) * 6
    i = 6
    i_df = 1
    ...
    while i <= l:
        ...
        if 600 <= mpd['Диаметр'][j] and mpd['Тип прокладки'][j] == 'надземная':
            ...
            if 'Труба' in mpd['Наименование и техническая характеристика'][j]:
                ...
                column_l[i + 2].value = column_k[i + 2].value * column_d[i].value
            ...
            if 'Труба' in mpd['Наименование и техническая характеристика'][j]:
                ...
                column_i[i + 4].number_format = "0.000"
                column_j[i + 4].value = mpd['Сталь 0.5мм'][j] * mpd['Количество'][j]
                column_k[i + 2].value = list_of_insulation[n]
                column_k[i + 2].number_format = "0.000"
                column_l[i + 2].value = column_k[i + 2].value * column_d[i].value
                column_l[i + 2].number_format = "0.000"
        ...
        if mpd['Диаметр'][j] >= 250 and mpd['Тип прокладки'][j] == 'подземная':
            ...
            if 'Труба' in mpd['Наименование и техническая характеристика'][j]:
                ...
                column_i[i + 4].number_format = "0.000"
                column_j[i + 4].value = mpd['Покрытие защ.Т-23'][j] * mpd['Количество'][j]
                column_j[i + 4].number_format = "0.000"
                column_k[i + 2].value = list_of_insulation[n]
                column_k[i + 2].number_format = "0.000"
                column_l[i + 2].value = column_k[i + 2].value * column_d[i].value
    ...
    sheet.oddFooter.left.text = КодKKS + '\n' + Архивный #, sep = '\n'
    return book
book = mpd_write()
book.save(КодKKS + "-MPD0001.xlsx")
...
def mpa_write():
    ...
    'Болт М12 * Длина вертикальных участков', 'Гайка М8 * Длина вертикальных участков', 'Гайка М12 * Длина вертикальных участков'].sum()
    ...
    while i <= l:
        ...
        column_l[i].value = 'Объем дан с учетом коэффициентов. Объем без учёта коэффициентов' + ' ' + str(
            (mpa_slise['mati_2m100_80mm * Количество'][j]).round(3)) +' м3' #+str(mycell.value)
        column_a[i + 1].value = m + 2
        column_g[i + 1].value = mpa_slise['mati_2m100_70mm * Количество'][j] * 1.236
        column_d[i + 1].value = 'Сборный'
        column_f[i + 1].value = 'м3'
        ...
        column_l[i + 1].value = 'Объем дан с учетом коэффициентов. Объем без учёта коэффициентов' + ' ' + str(
            (mpa_slise['mati_2m100_70mm * Количество'][j]).round(3)) + ' м3'
        column_a[i + 2].value = m + 3
        column_g[i + 2].value = mpa_slise['mati_2m100_60mm * Количество'][j] * 1.236
        ...
        column_l[i + 2].value = 'Объем дан с учетом коэффициентов. Объем без учёта коэффициентов' + ' ' + str(
            (mpa_slise['mati_2m100_60mm * Количество'][j]).round(3)) + ' м3'
        column_a[i + 3].value = m + 4
        column_g[i + 3].value = mpa_slise['mati_2m100_50mm * Количество'][j] * 1.236
        column_d[i + 3].value = 'Сборный'
        column_f[i + 3].value = 'м3'
        ...
        column_l[i + 3].value = 'Объем дан с учетом коэффициентов. Объем без учёта коэффициентов' + ' ' + str(
            (mpa_slise['mati_2m100_50mm * Количество'][j]).round(3)) + ' м3'
        column_a[i + 4].value = m + 5
        column_g[i + 4].value = mpa_slise['mati_2m100_40mm * Количество'][j] * 1.236
        column_d[i + 4].value = 'Сборный'
        column_f[i + 4].value = 'м3'
        ...
        column_l[i + 4].value = 'Объем дан с учетом коэффициентов. Объем без учёта коэффициентов' + ' ' + str(
            (mpa_slise['mati_2m100_40mm * Количество'][j]).round(3)) + ' м3'
        column_a[i + 5].value = j + 6
        column_g[i + 5].value = mpa_slise['mati_m100_70mm * Количество'][j] * 1.236
        column_d[i + 5].value = 'Сборный'
        column_f[i + 5].value = 'м3'
        ...
        column_l[i + 5].value = 'Объем дан с учетом коэффициентов. Объем без учёта коэффициентов' + ' ' + str(
            (mpa_slise['mati_m100_70mm * Количество'][j]).round(3)) + ' м3'
        column_a[i + 6].value = j + 7
        column_g[i + 6].value = mpa_slise['mati_m100_60mm * Количество'][j] * 1.236
        column_d[i + 6].value = 'Сборный'
        column_f[i + 6].value = 'м3'
        ...
        column_l[i + 6].value = 'Объем дан с учетом коэффициентов. Объем без учёта коэффициентов' + ' ' + str(
            (mpa_slise['mati_m100_60mm * Количество'][j]).round(3)) + ' м3'
        column_a[i + 7].value = j + 8
        column_g[i + 7].value = mpa_slise['mati_m100_50mm * Количество'][j] * 1.236
        column_d[i + 7].value = 'Сборный'
        column_f[i + 7].value = 'м3'
        ...
        column_l[i + 7].value = 'Объем дан с учетом коэффициентов. Объем без учёта коэффициентов' + ' ' + str(
            (mpa_slise['mati_m100_50mm * Количество'][j]).round(3)) + ' м3'
        column_a[i + 8].value = j + 9
        ...
        column_g[i + 8].value = (mpa_slise['T_23_2m100_80mm'][j] + mpa_slise['T_23_2m100_70mm'][j] +
            mpa_slise['T_23_2m100_60mm'][j] + mpa_slise['T_23_2m100_50mm'][j]) * 1.236
        column_l[i + 8].value = '(для матов в обкладках)'
        column_f[i + 8].value = 'м2'
        column_e[i + 8].value = 'по типу ТУ 6-11-231-76'
        column_a[i + 9].value = j + 10
        ...
        column_e[i + 14].value = 'по типу ТУ 36-1492-77'
        column_a[i + 15].value = j + 16
        column_c[i + 15].value = 'Лента стальная упаковочная 0,7х20 мм'
        column_g[i + 15].value = mpa_slise['Лента АД1.08х20 * Количество'][j].round(3)
        column_f[i + 15].value = 'кг.'
        column_d[i + 15].value = 'Углеродистая сталь'
        column_e[i + 15].value = 'ГОСТ 3560-73'
        column_a[i + 16].value = j + 17
        ...
        column_e[i + 21].value = 'по типу ТУ 36-1492-77'
        column_a[i + 22].value = j + 23
...
book_mpa = mpa_write()
book_mpa.save(КодKKS + "-MPA0001.xlsx")
...
def mdb_write():
    mdb = DocxTemplate("Template-MDB0001.docx")
    context = {'КодKKSРД': КодKKSдокумента, 'КодKKSспецификацииРД': КодKKSспецификацииРД,
               ...
               'КодKKSдокумента': КодKKSдокумента,
               'номерМДС': номерМДС, 'Архивный': Архивный, 'пункт_графика': пункт_графика}
    mdb.render(context)
    return mdb

mdb = mdb_write()
mdb.save(КодKKS + '-MDB0001.docx')

def maa_write():
    maa = DocxTemplate("Template-MAA0001.docx")
    context = {'КодKKSдокумента' : КодKKSдокумента, 'Наименование_работы' : Наименование_работы,
    'Исполнитель_должн' : Исполнитель_должн, 'Исполнитель' : Исполнитель, 'Архивный' : Архивный}
    maa.render(context)
    return maa

maa = maa_write()
maa.save(КодKKS + "-MAA0001.docx")

def maz_write():
    maz = DocxTemplate("Template-MAZ0001.docx")
    context = {'КодKKSдокумента' : КодKKSдокумента}
    maz.render(context)
    return maz

maz = maz_write()
maz.save(КодKKS + "-MAZ0001.docx")

def mab_write():
    mab = DocxTemplate("Template-MAB0001.docx")
    context = {'КодKKSдокумента' : КодKKSдокумента}
    mab.render(context)
    return mab

mab = mab_write()
mab.save(КодKKS + "-MAB0001.docx")


def ls_write():
    ls = DocxTemplate("Template-LS.docx")
    context = {'КодKKSдокумента' : КодKKS, 'Исполнитель' : Исполнитель, 'Архивный' : Архивный}
    ls.render(context)
    return ls

ls = ls_write()
ls.save("Лист согласования.docx")

def checklist_write():
    checklist = DocxTemplate("Template-checklist.docx")
...
checklist.save("Чек лист.docx")

def estimate_task_write():
    estimate_task = DocxTemplate("Template-estimate_task.docx")
    context = {'КодKKSдокумента' : КодKKSдокумента, 'пункт_графика' : пункт_графика}
    estimate_task.render(context)
    return estimate_task

estimate_task = estimate_task_write()
estimate_task.save("задание на сметы.docx")


def ul_write():
    ul = DocxTemplate("Template-ul.docx")
    context = {'дата' : дата, 'Архивный' : Архивный, 'Исполнитель' : Исполнитель, 'Наименование_работы' : Наименование_работы}
    ul.render(context)
    return ul

ul = estimate_task_write()
ul.save("Удостоверяющий лист.docx")


def protocol_write():
    protocol = DocxTemplate("Template-protocol.docx")
    context = {'дата' : дата, 'Архивный' : Архивный, 'Исполнитель' : Исполнитель, 'Наименование_работы' : Наименование_работы,
'Исполнитель_должн' : Исполнитель_должн, 'КодKKSдокумента' : КодKKSдокумента}
    protocol.render(context)
    return protocol

protocol = protocol_write()
protocol.save("Протокол.docx")
